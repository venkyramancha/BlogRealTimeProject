...
send_mail('Hello', 'Very imp msg....','venkateshramancha888.com',['venkythealone777@gmail.com','venkateshramancha001@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'venkateshramancha888@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
